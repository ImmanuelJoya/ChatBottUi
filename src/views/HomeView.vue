...
<template>
    <dev class="h-screen flex items-center justify-center bg-gray-900 text-white">
        <div class="p-8 bg-gray-800 rounded-lg shadow-lg w-full max-w-md">
            <img :src="AE" alt="AI" class="mx-auto w-24 h-24 mb-4 rounded-lg">
            <h1 class="text-2xl font-semibold mb-4 text-center">Welcome to ChatAI</h1>
